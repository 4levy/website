        ...
        <div className="relative p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <motion.div
                className="relative w-14 h-14 rounded-2xl overflow-hidden bg-gradient-to-br from-sky-400 to-sky-600"
                whileHover={{ scale: 1.1, rotate: 10 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <motion.svg
                  className="w-8 h-8 text-white absolute inset-0 m-auto"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  animate={{
              ...
              <div>
                <motion.h3
                  className="text-xl font-semibold bg-gradient-to-r from-sky-300 to-sky-500 bg-clip-text text-transparent"
            ...
            <div className="flex items-center gap-3">
              <motion.a
                ...
                className="px-5 py-2.5 rounded-lg bg-sky-500 text-white text-sm font-medium
                  hover:bg-sky-400 transition-colors relative overflow-hidden group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.button
                ...
                className="p-2 hover:bg-sky-500/10 rounded-lg transition-all"
          ...
          <AnimatePresence>
            {isMounted && isExpanded && (
              ...
              >
                <div className="mt-6 rounded-xl overflow-hidden border border-sky-500/10">
                  <iframe
