    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {projects.map((project) => (
        ...
        >
          ...
          <p className="text-ice-blue/70 mb-4">{project.description || "No description available"}</p>
          <div className="flex flex-wrap gap-4 text-sm">
            {project.language && (
              <span className="px-3 py-1 rounded-full glass-card text-glow">{project.language}</span>
            )}
